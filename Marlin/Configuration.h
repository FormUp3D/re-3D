...
#define STRING_CONFIG_H_AUTHOR "(V4.1.2 GB2 Thermocouple Filament Detection)" // Who made the changes.
...
#define HOMING_FEEDRATE {1500, 1500, 200, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {118.52,118.52,4031.5,1750} // default steps per unit for Ultimaker
...
#define CHANGE_FILAMENT_TEMP    200
//LCD and SD support
